...
public class MapsActivity extends ActionBarActivity implements GoogleApiClient.OnConnectionFailedListener,GoogleApiClient.ConnectionCallbacks, LocationListener {
    ...
    public void onConnected(Bundle connectionHint) {
        ...
        if(currentLocation != null) {
            ...
            Utils.setDefaults("latitude",String.valueOf(currentLocation.getLatitude()),getApplicationContext());
            Utils.setDefaults("longitude",String.valueOf(currentLocation.getLongitude()),getApplicationContext());
    ...
    public class CardBackFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            Log.d("Fragment","Showing back listview fragment");
            return inflater.inflate(R.layout.activity_maps_back, container, false);
        }
