...
public class ScrollViewFragment2 extends ScrollTabHolderFragment implements NotifyingScrollView.OnScrollChangedListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_scrollview2, null);
