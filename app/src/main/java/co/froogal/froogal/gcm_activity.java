...
public class gcm_activity extends ActionBarActivity {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_gcm_activity, menu);
        return true;
    }
    ...
    private class ProcessWeb extends AsyncTask<String, String, JSONObject> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(gcm_activity.this);
        ...
        protected JSONObject doInBackground(String... args) {
            ...
            JSONObject json = userFunction.gcmtest("Done Success");
