...
/**
 * Created by akhil on 29/5/15.
 */
public class ResDetailsActivity extends AppCompatActivity implements ScrollTabHolder, ViewPager.OnPageChangeListener {
    ...
    int[] photos={R.drawable.ic_launcher, R.drawable.ic_launcher,R.drawable.ic_launcher};
    ImageView imageView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mSpannableString = new SpannableString("Restaurant Name");

        mHeaderLogo = (TextView) findViewById(R.id.header_thumbnail);
    ...
    public class PagerAdapter extends FragmentPagerAdapter {
        ...
        private final String[] TITLES = { "Offers", "About", "Reviews", "Menu"};
        private ScrollTabHolder mListener;

        public PagerAdapter(FragmentManager fm) {
            super(fm);
            mScrollTabHolders = new SparseArrayCompat<ScrollTabHolder>();
            fragments.add(ScrollViewFragment.class.getName());
            fragments.add(ScrollViewFragment1.class.getName());
            fragments.add(ScrollViewFragment2.class.getName());
            fragments.add(ScrollViewFragment3.class.getName());
        ...
        public Fragment getItem(int position) {
            Log.d("ADebugTag", "Value: " + Float.toString(position));
