package co.circe.respos.library;
...
public class UserFunctions {
    ...
    private static String webURL = "http://54.188.153.91/";
    //URL of the PHP API
    private static String loginURL =  "files/login.php";
    private static String registerURL = "files/signup.php";
    private static String forpassURL = "files/forgotpass.php";
    private static String chgpassURL = "files/changepass.php";
    private static String gcm_testingURL = "http://ec2-52-10-172-112.us-west-2.compute.amazonaws.com";
    private static String save_token_to_server_URL = "files/save_token_to_server.php";
    private static String save_location_to_server_URL = "/save_location_to_server.php";
    private static String save_google_user_data_to_server_URL = "files/save_google_user_data_to_server.php";
    private static String save_facebook_user_data_to_server_URL = "files/save_facebook_user_data_to_server.php";
    private static String send_mobile_verification_status_URL = "files/send_mobile_verification_status.php";
    private static String recharge_URL = "files/rechargemobile.php";
    private static String bank_URL = "files/bank.php";
    private static String shopex_URL ="files/shopex.php";
    ...
    public JSONObject send_mobile_verification_status(String uid, String number, String status) {
        ...
        JSONObject json = jsonParser.makeHttpRequest(webURL + send_mobile_verification_status_URL, "POST", params);
    ...
    public JSONObject save_facebook_user_data_to_server(String id, String gcm_token, String first_name, String last_name, String image_url, String email, String ip_address, String imei, String registered_through, String latitude, String longitude, String registered_at, String birthday) {
        ...
        JSONObject json = jsonParser.makeHttpRequest(webURL + save_facebook_user_data_to_server_URL, "POST", params);
        Log.d(TAG, "Json Response : " + json);
        return json;
    }
    ...
    public JSONObject save_google_user_data_to_server(String gcm_token, String first_name, String last_name, String image_url, String email, String ip_address, String imei, String registered_through, String latitude, String longitude, String registered_at, String birthday, String id) {
        ...
        params.add(new BasicNameValuePair("special_id", id));
        Log.d(TAG, "Params : " + params.toString());
        JSONObject json = jsonParser.makeHttpRequest(webURL + save_google_user_data_to_server_URL, "POST", params);
        Log.d(TAG, "Json Response : " + json);
        return json;
    }
    ...
    public JSONObject registerUser(String fname, String lname, String email, String password, String registered_at, String registered_through, String imei, String ip_address, String image_url, String longitude, String latitude, String gcm_token) {
        ...
        JSONObject json = jsonParser.makeHttpRequest("http://54.188.153.91/files/signup.php", "POST", params);
    ...
    public JSONObject loginUser(String email, String password, String gcm_token) {
        ...
        params.add(new BasicNameValuePair("password", password));
        params.add(new BasicNameValuePair("gcm_token", gcm_token));
        JSONObject json = jsonParser.makeHttpRequest(webURL + loginURL, "POST", params);
    ...
    public JSONObject chgPass(String oldpass, String newpass, String uid) {
        ...
        JSONObject json = jsonParser.makeHttpRequest(webURL + chgpassURL, "POST", params);
    ...
    public JSONObject forPass(String email) {
        ...
        params.add(new BasicNameValuePair("email", email));
        JSONObject json = jsonParser.makeHttpRequest(webURL + forpassURL, "POST", params);
    ...
    public JSONObject getMenu(String s) {
        ...
        JSONObject json = jsonParser.makeHttpRequest(webURL + "files/getmenu.php", "GET", params);
    ...
    public JSONObject getRestaurants(String latitude, String longitude, String uid) {
        ...
        JSONObject json = jsonParser.makeHttpRequest(webURL + "files/getRestaurants.php", "GET", params);
    ...
    public JSONObject getReviews(String s, String uid) {
        ...
        JSONObject json = jsonParser.makeHttpRequest(webURL + "files/getReviews.php", "GET", params);
    ...
    public JSONObject addReview(String userID, String resID, String rating, String title, String description) {
        ...
        JSONObject json = jsonParser.makeHttpRequest(webURL + "files/addReview.php", "POST", params);
        Log.d("infunctionregREVIEW", json.toString());
        return json;
    ...
    public JSONObject processOrder(String userID, String resID, Map<String, String> products) {
        ...
        JSONObject json = jsonParser.makeHttpRequest(webURL + "files/processOrder.php", "POST", params);
    ...
    public JSONObject processCloseOrder(String userID, String resID) {
        ...
        JSONObject json = jsonParser.makeHttpRequest(webURL + "files/closeOrder.php", "POST", params);
        Log.d("GAGAGAGAG", json.toString());
    ...
    public JSONObject getProcessOrder(String userID, String resID) {
        ...
        JSONObject json = jsonParser.makeHttpRequest(webURL + "files/getProcessOrder.php", "GET", params);
    ...
    public JSONObject updateReview(String userID, String resID, String rating, String title, String description) {
        ...
        JSONObject json = jsonParser.makeHttpRequest(webURL + "files/updateReview.php", "POST", params);
    ...
    public JSONObject getPopRestaurants(String latitude, String longitude, String uid) {
        ...
        params.add(new BasicNameValuePair("latitude", latitude));
        params.add(new BasicNameValuePair("userID", uid));
        JSONObject json = jsonParser.makeHttpRequest(webURL + "files/getPopRestaurants.php", "GET", params);
    ...
    public JSONObject getFavRestaurants(String uid) {
        ...
        params.add(new BasicNameValuePair("tag", register_tag));
        params.add(new BasicNameValuePair("userID", uid));
        JSONObject json = jsonParser.makeHttpRequest(webURL + "files/getFavRestaurants.php", "GET", params);
    ...
    public JSONObject get_menu_dine_in(String latitude, String longitude, String value) {
        ...
        JSONObject json = jsonParser.makeHttpRequest(webURL + "files/get_menu_dine_in.php", "POST", params);
        Log.d("infunctionregREVIEW", json.toString());
        return json;
    }
    ...
    public JSONObject getRewardsList(String uid) {
        ...
        params.add(new BasicNameValuePair("tag", register_tag));
        params.add(new BasicNameValuePair("userID", uid));
        JSONObject json = jsonParser.makeHttpRequest(webURL + "files/getRewardsList.php", "GET", params);
        Log.d("infunctionregREAURANT2", json.toString());
        return json;
    }
    ...
    public JSONObject processFav(String isFav, String uid, String resID) {
        ...
        JSONObject json = jsonParser.makeHttpRequest(webURL + "files/processFav.php", "POST", params);
        Log.d("infunctionregREAURANT2", json.toString());
        return json;
    }
    ...
    public JSONObject updateUser(String uid, String fname, String lname, String email) {
        ...
        JSONObject json = jsonParser.makeHttpRequest(webURL + "files/updateUser.php", "POST", params);
        Log.d("infunctionregREAURANT2", json.toString());
        return json;
    }
    ...
    public JSONObject invalidateMobile(String uid, String mobile) {
        ...
        JSONObject json = jsonParser.makeHttpRequest(webURL + "files/invalidateMobile.php", "POST", params);
        Log.d("infunctionregREAURANT2", json.toString());
        return json;
    }
    ...
    public JSONObject getRewardsSpentList(String uid) {
        ...
        params.add(new BasicNameValuePair("tag", register_tag));
        params.add(new BasicNameValuePair("userID", uid));
        JSONObject json = jsonParser.makeHttpRequest(webURL + "files/getRewardsSpentList.php", "GET", params);
        Log.d("infunctionregREAURANT2", json.toString());
        return json;
    }
    ...
    public JSONObject getOffers(String resID) {
        ...
        params.add(new BasicNameValuePair("tag", register_tag));
        params.add(new BasicNameValuePair("resID", resID));
        JSONObject json = jsonParser.makeHttpRequest(webURL + "files/getOffers.php", "GET", params);
        Log.d("infunctionregREAURANT2", json.toString());
        return json;
    }
